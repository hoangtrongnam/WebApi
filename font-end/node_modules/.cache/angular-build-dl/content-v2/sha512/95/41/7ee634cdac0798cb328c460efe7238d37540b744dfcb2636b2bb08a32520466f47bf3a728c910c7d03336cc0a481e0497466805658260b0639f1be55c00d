...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[0], {
  ...
  /***/
  function srcAppPagesCustomerPageCustomerRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    "./src/app/pages/customer-page/product/product.component.ts"); // import { RoleComponent } from './role';
  ...
  /***/
  function srcAppPagesCustomerPageCustomerModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _customer_routing_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
